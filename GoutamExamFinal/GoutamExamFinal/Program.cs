...
namespace GoutamExamFinal
{
    class Program
    {
        ...
        {
            {
                Console.WriteLine("\r\nHello Sir.........");
                Console.WriteLine("\r\nChoose any Question: ");
                Console.WriteLine("1. **Print Name and Real Date**");
                Console.WriteLine("2. **Count Characters in Line**");
                Console.WriteLine("3. **Even and Odd Number**");
                Console.WriteLine("4. **Print a Count to TEN**");
                Console.WriteLine("5. **Calculate the ADD and Multiplication of two numbers**");
                Console.WriteLine("6. **Show Day with specific DATE**");
                ...
                Console.WriteLine("10. **Factrial Number**");
        ...
        private static void Q1()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Q1. **Print Name and Real Date**");
                DateTime now = DateTime.Now;
                Console.WriteLine("\nMr.Goutam Das. The date and Time is Now: " + now);
                Console.ReadLine();
                Console.Clear();
            }
            catch
        ...
        private static void Q2()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Q2. **Count Characters in Line**");
                Console.WriteLine("\nWrite a Line: ");
        ...
        private static void Q3()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Q3. **Even and Odd Number**");
                int i;
                Console.Write("\nEnter a Number : ");
        ...
        private static void Q4()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Q4. **Print a Count to TEN**");
                int i;
        ...
        private static void Q5()
        {
            try
            {
                ...
                Console.Clear();
                Console.WriteLine("Q5. **Calculate the ADD and Multiplication of two numbers**");
        ...
        private static void Q6()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Q6. **Show Day with specific DATE**");
        ...
        private static void Q10()
        {
            try
            {
                ...
                Console.Clear();
                Console.WriteLine("Q10. **Factrial Number**");
                Console.WriteLine("\nPut the Numbers : ");
